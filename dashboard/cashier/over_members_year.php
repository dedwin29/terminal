...
<head><title>Platea21 -Gym ,Un sistema completo de gestión Fitness y Administración</title>
...
?></span>
				...
				<div class="breadcrumbs">
					...
					<div class="span12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3><i class="icon-th-list"></i>Vista General</h3>
							</div>
 ...
 <div class="control-group">
										<label for="textfield" class="control-label">De :</label>
										<div class="controls"><span id="sprytextfield3">
										  <input type="text" name="from" id="textfield22" class="input-medium datepick" value="<?php
echo date('Y-m-d');
?>">
									    <span class="textfieldRequiredMsg">Se requiere un valor.</span></span></div>
									</div>



 <div class="control-group">
										<label for="textfield" class="control-label">A :</label>
										<div class="controls"><span id="sprytextfield3">
...
?>">
									...
									<center><h4>Platea21-Gym ,Un sistema completo de gestión Fitness y Administración</h4>
									<p><a href="http://platea21.blogspot.com">Desarrollado por Platea21</a> Powered
