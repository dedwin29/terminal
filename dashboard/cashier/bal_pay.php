    ...
    <body class="page-body  page-fade">
		...
		<form action="bal_pay_submit.php" enctype="multipart/form-data" method="POST" role="form" class="form-horizontal form-groups-bordered">
			...
			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">Member Nombre :</label>
					<div class="col-sm-5">
			...
			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">Invoice :</label>
					<div class="col-sm-5">
						 <input type="text" name="invoice" id="textfield3" class="form-control" data-rule-required="true" data-rule-minlength="4" value ='<?php echo $invoice; ?>' placeholder="Nombre del Plan" maxlength="100"class="uneditable-input"  readonly>
					</div>
			</div>
