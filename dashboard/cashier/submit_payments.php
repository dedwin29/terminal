...
?></span></td>
    ...
    <aside>
      ...
      <div  >
        <p>1 ) . Todos los miembros deben respetar nuestros TyC / normas normalmente de miembros podrán retirarse. </br></br>2). El pago no es transferible y no reembolsable.</br></br>3).Fee Should be submitted within 5 business days before subjected to expiration, otherwise 100 PHP/Day will be charged.</br></br>4).All users should dress appropriately Or as per advised.</br></br>5).Smoking is NOT permitted at the Gym site.</br></br>6). A PHP 1000 for breaking/scracthing glasses belonging to "Platea21's Gym" will be imposed.
      </div>
